...
DirtyJTAG is a Zephyr-based JTAG adapter firmware for low-cost USB-capable development boards and repurposed debug probes. The DirtyJTAG project was meant to be an alternative to the obsolete (but cheap) LPT Wiggler cables, and other expensive USB JTAG probes.
 ...
 * [Compiling DirtyJTAG yourself with Zephyr](docs/building-dirtyjtag.md)
 * [Architecture and vendored legacy source](docs/architecture.md)
