...
#if defined(CONFIG_DJPROG_MAX_PAYLOAD)
#define DJP2_MAX_PAYLOAD CONFIG_DJPROG_MAX_PAYLOAD
#else
...
enum djp2_cmd {
	...
	DJP2_POWER = 0x40,
	DJP2_MEASURE = 0x41,
	DJP2_SET_PINMAP = 0x42,
	DJP2_VPP = 0x43,
	DJP2_PHY_INFO = 0x44,
	DJP2_SCRIPT_XFER = 0x45,
	DJP2_BRIDGE_INFO = 0x46,
	DJP2_BRIDGE_GPIO = 0x47,
	DJP2_BRIDGE_SPI = 0x48,
	DJP2_BRIDGE_I2C = 0x49,
	DJP2_BRIDGE_UART = 0x4a,
	DJP2_POWER_TRACE = 0x4b,
	DJP2_SAFETY_STATUS = 0x4c,
	DJP2_SAFETY_ARM = 0x4d,
	DJP2_SAFETY_DISARM = 0x4e,
	DJP2_DEBUG_BITBANG = 0x50,
	DJP2_DEBUG_INFO = 0x51,
	DJP2_DEBUG_ATTACH = 0x52,
	DJP2_DEBUG_DETACH = 0x53,
	DJP2_DEBUG_HALT = 0x54,
	DJP2_DEBUG_RUN = 0x55,
	DJP2_DEBUG_STEP = 0x56,
	DJP2_DEBUG_RESET = 0x57,
	DJP2_DEBUG_REG_READ = 0x58,
	DJP2_DEBUG_REG_WRITE = 0x59,
	DJP2_DEBUG_BP_SET = 0x5a,
	DJP2_DEBUG_BP_CLEAR = 0x5b,
	DJP2_RTT_SCAN = 0x60,
	DJP2_RTT_INFO = 0x61,
	DJP2_RTT_READ = 0x62,
	DJP2_RTT_WRITE = 0x63,
	DJP2_RTT_CHANNEL_INFO = 0x64,
	DJP2_SWO_CONFIG = 0x68,
	DJP2_SWO_START = 0x69,
	DJP2_SWO_STOP = 0x6a,
	DJP2_SWO_READ = 0x6b,
	DJP2_SWO_STATUS = 0x6c,
	DJP2_SAFE_IDLE = 0x7e,
	DJP2_ABORT = 0x7f
};
enum djp2_status {
