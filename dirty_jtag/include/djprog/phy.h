...
int dj_uart_1wire_txrx_ex(const uint8_t *tx, size_t txlen, uint8_t *rx, size_t rxlen, uint32_t baud,
                          bool invert, enum dj_uart_parity parity, unsigned stop_bits);
